...
// src/create-installation-token.ts
var create_installation_token_exports = {};
__export(create_installation_token_exports, {
  createInstallationAccessToken: () => createInstallationAccessToken
});
module.exports = __toCommonJS(create_installation_token_exports);
...
legacyRestEndpointMethods.VERSION = VERSION11;

// node_modules/@octokit/rest/dist-src/version.js
var VERSION12 = "22.0.1";

// node_modules/@octokit/rest/dist-src/index.js
var Octokit2 = Octokit.plugin(requestLog, legacyRestEndpointMethods, paginateRest).defaults(
  {
    userAgent: `octokit-rest.js/${VERSION12}`
  }
);
...
async function createInstallationAccessToken(config) {
  ...
  const appAuthentication = await auth6({
    type: "app"
  });
  ...
  const installationAuthentication = await auth6({
    type: "installation",
    installationId
  });
